...
import "../Styles/13YearsBlock.css"
  ...
  return (
    ...
    <div class="container">
        <div class="row col-md-6">
            ...
            <div class="competencies-13-years-name">
                    ...
                    <div class="competency-wrapper">
                        <div class="competency-header">
                            <div class="background-icon">
                              <img src="images/icon-bg.svg" alt="Задний фон блока 1" class="img-responsive"/></div>
                            <div class="competency-icon"><img src="images/competency-1.svg" alt="Иконка блока 1"
                                    class="img-responsive"/></div>
                        </div>
                        <div class="competency-body">
                            Добавление <br/> информации на сайт,<br/> создание новых <br/>
                            разделов
                        </div>
                    </div>
                </div>
